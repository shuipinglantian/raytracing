...
{
    copyShader_.initializeStageFromFile<CS>("./asset/02/view_z.hlsl", nullptr, "CSMain");
    copyShaderRscs_ = copyShader_.createResourceManager();

    genShader_.initializeStageFromFile<CS>("./asset/02/mipmap.hlsl", nullptr, "CSMain");
...
void MipmapsGenerator::generate(ComPtr<ID3D11ShaderResourceView> gbufferB)
{
    ...
    {
		return Int2((res.x + 16 - 1) / 16, (res.x + 16 - 1) / 16);
    };
