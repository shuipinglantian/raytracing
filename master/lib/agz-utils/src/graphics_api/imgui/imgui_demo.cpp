...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    static bool show_app_windowtitles = false;
    ...
    if (show_app_windowtitles)       ShowExampleAppWindowTitles(&show_app_windowtitles);
    ...
    if (!ImGui::Begin("Dear ImGui Demo", p_open, windowflags))
    {
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
            ...
            ImGui::MenuItem("Manipulating window titles", NULL, &show_app_windowtitles);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // Child 1: no border, enable horizontal scrollbar
        {
            ...
            ImGui::BeginChild("ChildL", ImVec2(ImGui::GetWindowContentRegionWidth() * 0.5f, 260), false, windowflags);
            for (int i = 0; i < 100; i++)
        ...
        // Child 2: rounded border
        {
            ...
            ImGui::BeginChild("ChildR", ImVec2(0, 260), true, windowflags);
    ...
    if (ImGui::TreeNode("Basic Horizontal Layout"))
    {
        ...
        for (int n = 0; n < buttons_count; n++)
        {
            ...
            if (n + 1 < buttons_count && next_button_x2 < windowvisible_x2)
                ImGui::SameLine();
            ImGui::PopID();
        }
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        if (ImGui::BeginTabItem("Sizes"))
        {
            ...
            int windowmenu_button_position = style.WindowMenuButtonPosition + 1;
            if (ImGui::Combo("WindowMenuButtonPosition", (int*)&windowmenu_button_position, "None\0Left\0Right\0"))
                style.WindowMenuButtonPosition = windowmenu_button_position - 1;
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            if (ImGui::DragFloat("window scale", &windowscale, 0.005f, MIN_SCALE, MAX_SCALE, "%.2f", ImGuiSliderFlags_AlwaysClamp)) // Scale only this window
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    if (corner != -1)
    {
        ...
        ImVec2 windowpos_pivot = ImVec2((corner & 1) ? 1.0f : 0.0f, (corner & 2) ? 1.0f : 0.0f);
        ImGui::SetNextWindowPos(windowpos, ImGuiCond_Always, windowpos_pivot);
    }
    ImGui::SetNextWindowBgAlpha(0.35f); // Transparent background
    if (ImGui::Begin("Example: Simple overlay", p_open, windowflags))
    {
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists"))
        {
            ...
            if (draw_bg)
                ImGui::GetBackgroundDrawList()->AddCircle(windowcenter, windowsize.x * 0.6f, IM_COL32(255, 0, 0, 200), 0, 10 + 4);
            if (draw_fg)
                ImGui::GetForegroundDrawList()->AddCircle(windowcenter, windowsize.y * 0.6f, IM_COL32(0, 255, 0, 200), 0, 10);
            ImGui::EndTabItem();
        }
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    bool windowcontents_visible = ImGui::Begin("Example: Documents", p_open, ImGuiWindowFlags_MenuBar);
    if (!windowcontents_visible)
    {
        ImGui::End();
        return;
    }
